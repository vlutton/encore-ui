...
1. Include the Encore CSS file in the `<head>` of your index.html:
    ...
    ```
    <link rel="stylesheet" href="https://95c7050854423f809e66-6999ba0e7a4f47d417515fb3f08fa9b8.ssl.cf1.rackcdn.com/0.0.5/encore-ui.min.css">
    ```
...
3. Include the Encore JS file (**Dependencies must be included before this line**):
    ...
    ```
    <script src="https://95c7050854423f809e66-6999ba0e7a4f47d417515fb3f08fa9b8.ssl.cf1.rackcdn.com/0.0.5/encore-ui-tpls.min.js"></script>
    ```
...
You can see all components in action by visiting [the Encore UI demo page](https://95c7050854423f809e66-6999ba0e7a4f47d417515fb3f08fa9b8.ssl.cf1.rackcdn.com/0.0.5/index.html).
